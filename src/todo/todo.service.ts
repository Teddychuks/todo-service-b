...
export class TodoService {
  ...
  async create(createTodoDto: CreateTodoDto): Promise<TodoResponseDto> {
    this.logger.log(
      `Forwarding create todo request to service-a: ${JSON.stringify(createTodoDto)}`,
    );
    ...
    try {
      ...
      this.logger.error(
        `Error forwarding create todo request: ${error.message}`,
      );
  ...
  async findAll(): Promise<TodoResponseDto[]> {
    ...
    try {
      ...
      this.logger.error(
        `Error forwarding get all todos request: ${error.message}`,
      );
      throw new HttpException(
  ...
  async findOne(id: number): Promise<TodoResponseDto> {
    ...
    try {
      ...
      this.logger.error(
        `Error forwarding get todo request for ID ${id}: ${error.message}`,
      );
      throw new HttpException(
  ...
  async update(
    ...
    this.logger.log(
      `Forwarding update todo request for ID ${id} to service-a: ${JSON.stringify(updateTodoDto)}`,
    );
    ...
    try {
      ...
      this.logger.error(
        `Error forwarding update todo request for ID ${id}: ${error.message}`,
      );
      throw new HttpException(
  ...
  async remove(id: number): Promise<{ success: boolean }> {
    ...
    try {
      ...
      this.logger.error(
        `Error forwarding delete todo request for ID ${id}: ${error.message}`,
      );
      throw new HttpException(
  ...
  async createTodoInOwnDatabase(data: CreateTodoRequest): Promise<Todo> {
    this.logger.log(
      `Creating todo in service-b database: ${JSON.stringify(data)}`,
    );
    ...
    try {
      ...
      this.logger.error(
        `Error creating todo in service-b database: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  async findAllInOwnDatabase(): Promise<{ todos: Todo[] }> {
    ...
    try {
      ...
      this.logger.error(
        `Error finding all todos in service-b database: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  async findOneInOwnDatabase(id: number): Promise<Todo> {
    ...
    try {
      ...
      this.logger.error(
        `Error finding todo with ID ${id} in service-b database: ${error.message}`,
      );
      throw error;
    }
  }

  async updateInOwnDatabase(
    id: number,
    updateTodoDto: UpdateTodoDto,
  ): Promise<Todo> {
    this.logger.log(
      `Updating todo with ID ${id} in service-b database: ${JSON.stringify(updateTodoDto)}`,
    );
    ...
    try {
      ...
      this.logger.error(
        `Error updating todo with ID ${id} in service-b database: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  async removeFromOwnDatabase(id: number): Promise<{ success: boolean }> {
    ...
    try {
      ...
      this.logger.error(
        `Error removing todo with ID ${id} from service-b database: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  private mapToGrpcUpdateRequest(
    id: number,
    dto: UpdateTodoDto,
  ): UpdateTodoRequest {
    return {
